    ...
    public void parse_validDataTicketIo_parsesData() {
        appointmentProvider.parse(VALID_APPOINTMENT)
                ...
                .assertValue(appointment -> {
                    ...
                    assertEquals(TestResult.TYPE_APPOINTMENT, appointment.getLucaTestResult().getType());
                    assertEquals(1622559373000L, appointment.getLucaTestResult().getTestingTimestamp());
                    return true;
                });
    }
