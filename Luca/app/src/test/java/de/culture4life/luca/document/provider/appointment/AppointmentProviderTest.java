...
public class AppointmentProviderTest extends LucaUnitTest {
    ...
    public static final String VALID_APPOINTMENT = "https://app.luca-app.de/webapp/appointment/?timestamp=1620802013000&type=Kostenloser%20Covid%2019%20B%C3%BCrgertest&lab=Test%20NOW%21%20Schnelltestzentrum%20PACHA&address=Maximiliansplatz%205%2C%2080333%20M%C3%BCnchen&qrCode=TerminID_1353d9b0-60f2-4f56-a816-1282b7faa04f";
    ...
    public void parse_validAppointment_parsesData() {
        appointmentProvider.parse(VALID_APPOINTMENT)
                ...
                .assertValue(appointment -> {
                    ...
                    assertEquals("1620802013000", appointment.timestamp);
                    ...
                    assertEquals(1620802013000L, appointment.getDocument().getTestingTimestamp());
                    assertEquals(1620802013000L + TimeUnit.HOURS.toMillis(2), appointment.getDocument().getExpirationTimestamp());
                    return true;
                });
    }
