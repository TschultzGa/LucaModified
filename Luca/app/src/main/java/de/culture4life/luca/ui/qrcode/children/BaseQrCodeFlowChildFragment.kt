...
abstract class BaseQrCodeFlowChildFragment<ChildViewModel : BaseQrCodeFlowChildViewModel, ParentViewModel : BaseFlowViewModel>
    : BaseFlowChildFragment<ChildViewModel, ParentViewModel>() {
