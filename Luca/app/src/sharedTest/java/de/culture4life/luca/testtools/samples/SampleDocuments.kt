...
import de.culture4life.luca.testtools.rules.FixedTimeRule.Companion.parseDateTime
...
interface SampleDocuments {
    ...
    companion object {
        ...
        val referenceDateTime: DateTime = parseDateTime("2021-06-15T15:30:00")
    }
    ...
    class ErikaMustermann : Person {
        ...
        class EudccPartiallyVaccinated : Vaccination() {
            ...
            override val vaccinationDate = parseDateTime("2021-05-05")
        ...
        class EudccFullyVaccinated : Vaccination() {
            ...
            override val vaccinationDate = parseDateTime("2021-05-10")
            override val qrCodeContent =
        ...
        class EudccBoosteredVaccinated : Vaccination() {
            ...
            override val lab = "Robert Koch-Institut"
            override val outcome = Document.OUTCOME_FULLY_IMMUNE
            override val vaccinationDate = parseDateTime("2021-05-15")
            override val qrCodeContent =
        ...
        class EudccRecovered : Recovery() {
            ...
            override val startDate = parseDateTime("2021-05-01")
        ...
        class EudccPcrNegative : CovidTestResult() {
            ...
            override val testingDateTime = parseDateTime("2021-06-15T10:30:00Z")
            override val qrCodeContent =
                "HC1:6BF780+80T9WTWGSLKC 4769R174TF//5P30FBB*A3WY0DJCFAAFN04HDO9E*70J+9D97TK0F90\$PC5\$CUZC\$\$5Y\$5TPCBEC7ZKW.CXJD7%E7WE/KECEC/.DI3D5 C*KE*PDLPCG/DXJDIZAITA9IANB8.+9I3D7WEGY8/B9:B8GVC*JCNF66463W5KF6SF6IECTHG4KCD3DX47B46IL6646H*6MWEF8DE6A1R6\$Q60S6KWEKDDC%6-Q6QW6646/JCI\$DR6A9HAITA2OA.JC2EC*96BL63KCZPCNF6OF63W59%6.96/SAG469L61G73564KC*PCME3J09R34ALESQE.WOY-DX34RW5: COED-3EA4F63DUPCBJCOT9+EDXVET3E5\$CSUE6O9NPCSW5F/DBWENWE4WEOPCD8F6%E3.DA%EOPC1G72A6J+9OG7J09S/59A6HB8/96ZB827B7CENMMLNGNPB2MKUHBXDGB.P9:V%6OVF84/O 9W.FV43R\$X824CI28C6N%\$0P2MAL25KM7%H\$P9YTJ3PNZ/CYZBYHN+GCXNR GM6VG"
        }

        class EudccPcrPositive : CovidTestResult() {
            override val person = ErikaMustermann()
            override val lab = "Robert Koch-Institut"
            override val documentType = Document.TYPE_PCR
            override val outcome = Document.OUTCOME_POSITIVE
            override val testingDateTime = parseDateTime("2021-06-15T10:30:00Z")
            override val qrCodeContent =
                "HC1:6BF780+80T9WTWGSLKC 4769R174TF//5P30FBB*A3WY0DJC1CAFN04HDABE*70J+9D97TK0F90\$PC5\$CUZC\$\$5Y\$5TPCBEC7ZKW.CXJD7%E7WE/KECEC/.DI3D5 C*KE*PDLPCG/DXJDIZAITA9IANB8.+9I3D7WEGY8/B9:B8GVC*JCNF66463W5KF6SF6IECTHG4KCD3DX47B46IL6646H*6MWEF8DE6A1R6\$Q60S6KWEKDDC%6GL69L6746/JCI\$DR6A9HAITA2OA.JC2EC*96BL63KCZPCNF6OF63W59%6.96/SAG469L61G73564KC*PCME3J09R34ALESQE.WOY-DX34RW5: COED-3EA4F63DUPCBJCOT9+EDXVET3E5\$CSUE6O9NPCSW5F/DBWENWE4WEOPCD8F6%E3.DA%EOPC1G72A6J+9OG7J09S/59A6HB8/96ZB827BTNUWBWHLMB.KXRIO6P:1WHENDVFI2IMZPS%K%W8OXRTE9S8LSJN1GP2EE7AKSZ4\$TKO-A/3R3OH0+QGFJ\$EVM52:1L5RF.VL%.SPIH"
        }

        class EudccFastNegative : CovidTestResult() {
            override val person = ErikaMustermann()
            override val lab = "Robert Koch-Institut"
            override val documentType = Document.TYPE_FAST
            override val outcome = Document.OUTCOME_NEGATIVE
            override val testingDateTime = parseDateTime("2021-06-15T10:30:00Z")
            override val qrCodeContent =
    ...
    abstract class Vaccination : SampleDocuments {
        ...
        abstract val vaccinationDate: DateTime
    }
